...
This **Model Context Protocol (MCP)** server enables AI agents to query live inference costs, benchmarks, and metrics across the AI inference market. Designed for cost-aware agents, FinOps teams, and developers optimizing LLM workloads.
